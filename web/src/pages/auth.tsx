...
// function Auth() {
//   const { login, register, requestPasswordReset } = useAuth(); // ✅ added reset
//   const navigate = useNavigate();
//   const location = useLocation();
//   const isSignup = location.pathname === "/signup";
//   const from = (location.state as any)?.from?.pathname || "/dashboard";
...
//   const [signupData, setSignupData] = useState({ email: "", password: "", name: "" });
//   const [loginData, setLoginData] = useState({ email: "", password: "" });
//   const [forgotEmail, setForgotEmail] = useState(""); // ✅ new
...
//   const handleNavigateToLogin = () => {
//     setError("");
//     setShowForgotPassword(false); // ✅ ensure back to login
//     navigate("/login");
//   };
...
//             <div className="text-center mb-8">
//               <h2 className="text-2xl font-semibold text-gray-900">
//                 {isSignup ? "Sign Up" : showForgotPassword ? "Forgot Password" : "Login"}
//               </h2>
//             </div>
...
//                   <Input id="name" name="name" type="text" value={signupData.name} onChange={handleSignupChange} required />
//                 </div>
//                 <div className="space-y-2">
...
//                   <Input id="forgotEmail" name="forgotEmail" type="email" value={forgotEmail} onChange={(e) => setForgotEmail(e.target.value)} required />
//                 </div>
//                 <Button type="submit" disabled={loading} className="w-full h-12 bg-gray-900 hover:bg-gray-800 text-white font-medium disabled:opacity-50">
//                   {loading ? "Sending..." : "Send Reset Link"}
//                 </Button>
//                 <div className="mt-4 text-center">
//                   <button type="button" onClick={() => setShowForgotPassword(false)} className="text-blue-600 hover:text-blue-700 text-sm">
//                     Back to Login
//                   </button>
//                 </div>
//               </form>
...
//                   <div className="mt-1">
//                     <button type="button" onClick={() => setShowForgotPassword(true)} className="text-blue-600 hover:text-blue-700 text-sm">
//                       Forgot password?
//                     </button>
//                   </div>
//                 </div>
...
//                   {isSignup ? (
//                     <>Already have an account?{" "}
//                       <button onClick={handleNavigateToLogin} className="text-blue-600 hover:text-blue-700 font-medium">Login</button>
//                     </>
//                   ) : (
//                     <>Don't have an account?{" "}
//                       <button onClick={handleNavigateToSignup} className="text-blue-600 hover:text-blue-700 font-medium">Sign up</button>
//                     </>
//                   )}
//                 </p>
//               </div>
...
function Auth() {
  const { login, register,requestPasswordReset } = useAuth(); //  now using both from context
  const navigate = useNavigate();
  const location = useLocation();
  const isSignup = location.pathname === "/signup";
  const from = (location.state as any)?.from?.pathname || "/dashboard";
