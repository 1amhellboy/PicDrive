  ...
  const TrashActions: React.FC<{ id: string; type: "file" | "folder" }> = ({
    ...
    <div className="flex space-x-1">
      <button
        ...
        className="flex items-center px-2 py-1 text-xs text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded transition-colors mt-2 mr-6"
      >
        <RotateCcw className="w-3 h-3 mr-1" />
        Restore
      </button>
